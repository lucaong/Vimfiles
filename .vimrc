...
let g:ale_linters = {'jsx': ['standard'], 'javascript': ['standard'], 'elixir': ['elixir-ls'], 'rust': ['cargo', 'analyzer']}
let g:ale_linter_aliases = {'jsx': 'css'}
let g:ale_fixers = {'jsx': ['standard'], 'javascript': ['standard'], 'elixir': ['mix_format'], 'rust': ['rustfmt']}
let g:ale_elixir_elixir_ls_release = $HOME.'/.vim/bundle/elixir-ls/release'
let g:ale_rust_analyzer_executable = $HOME.'/.vim/executables/rust-analyzer'
